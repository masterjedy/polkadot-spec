...
namespace storage {
    ...
    /// version 1
    void processStorageSet_version_1(const std::vector<std::string> &args);

    void processStorageGet_version_1(const std::vector<std::string> &args);

    void processStorageClear_version_1(const std::vector<std::string> &args);

    void processStorageExists_version_1(const std::vector<std::string> &args);

    void processStorageRead_version_1(const std::vector<std::string> &args);

    void processStorageClearPrefix_version_1(const std::vector<std::string> &args);

    void processStorageRoot_version_1(const std::vector<std::string> &args);

    void processStorageNextKey_version_1(const std::vector<std::string> &args);
